...
if ch == "Warmup":
    ...
    st.markdown('''<ul><li><p style="font-size:18px">Dataset used in the project.</p></li></ul><center><img src="https://user-images.githubusercontent.com/44704352/135705584-045c5031-28a7-4be7-9b1c-048c57511bcd.png", width="90%"></center><br><p style="font-size:16px">The dataset above shown gives a glimpse of various features and their expected value ranges.</p><hr><ul><li><p style="font-size:18px">Correlation plot</p></li></ul><img src="https://user-images.githubusercontent.com/44704352/135710617-29ea4aea-caa3-4ba6-946a-1d60adff96a7.png", height=50%, width=50%><p style="font-size:16px">Above plot shows how different independent variables are related to our dependent variable(calorie). On x-axis, different variables(features) are marked while on y-axis calorie is marked.<br>Higher the bar of a variable, stronger it is correlated with calorie. Value ranges between (0,1) where values closer to 0 shows weak correlation while values closer to 1 shows strong correlation.</p><hr><ul><li><p style="font-size:18px">Let's have a look on pairplot for 3 most relevant features i.e <u>duration, heart-rate, body-temperature</u> with <u>calories</u></p></li></ul>''',unsafe_allow_html=True)
